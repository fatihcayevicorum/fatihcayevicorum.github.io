...
1. ZIP içindeki dosyaları sitenin ana dizinine, klasör yapısını koruyarak yükleyin.
2. `firestore.rules` içeriğini Firebase Console → Firestore Database → Rules bölümünde yayınlayın.
3. Firebase Console → Storage bölümünü açıp Storage'ı etkinleştirin.
