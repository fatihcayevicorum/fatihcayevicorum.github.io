...
onAuthStateChanged(auth,current=>{user=current;if(current){startForeground().catch(()=>{});syncSavedDevice().catch(error=>console.error("Esnaf bildirim cihazı yenilenemedi:",error))}});
renderButton();
