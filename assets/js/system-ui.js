...
const adminPageFolders=["adisyon","adisyon-gecmisi","ana-sayfa-yonetimi","bildirim-merkezi","esnaf-yonetimi","kasa-hesap-yonetimi","kullanici-yonetimi","menu-yonetimi","personel-yonetimi","raporlar","siparis-listesi","stok-yonetimi","taze-dem-paneli","veri-yonetimi","yonetim-merkezi"],isAdminPage=adminPageFolders.some(folder=>location.pathname.includes(`/${folder}/`));
