...
if(adminPageFolders.some(folder=>location.pathname.includes(`/${folder}/`)))import("./admin-notifications.js?v=342").catch(error=>console.error("Uygulama içi bildirimler başlatılamadı:",error));
ensureFooter();
