(()=>{
  ...
  if(path.includes("/menu-yonetimi/")){
    ...
    setup({form:"productForm",title:"productFormTitle",triggerText:"Yeni Ürün",triggerIcon:"fa-plus",toolbar:()=>document.querySelector("#productList")?.closest(".panel")?.querySelector(".section-heading"),editSelector:"[data-edit-product]",removeSection:true});
  }
