...
async function saveProduct(event) {
    ...
    const product = {
        ...
        description: elements.productDescription.value.trim(), available: elements.productAvailable.checked, costMode:document.getElementById("productCostMode").value, recipe:recipeDraft.map(r=>({stockItemId:r.stockItemId,amount:Number(r.amount)}))
    };
