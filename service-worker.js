/* R349 - Kontrollu kredi odemesi duzeltmesi; R347 tabanli */
...
firebase.messaging();
const VERSION="fatih-cay-evi-r349-kredi-duzeltme",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
const CORE=[
