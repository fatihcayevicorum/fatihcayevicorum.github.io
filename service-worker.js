/* R350 - Tamamlanan kredi duzeltme butonu kaldirildi */
...
firebase.messaging();
const VERSION="fatih-cay-evi-r350-kredi-buton-kaldirma",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
const CORE=[
