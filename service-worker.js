/* R363 - Menu receteleri ve malzeme stok dusumu */
...
firebase.messaging();
const VERSION="fatih-cay-evi-r363-recete",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
const CORE=["./assets/js/stock-recipe.js",
