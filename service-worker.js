/* R378 - Raporlarda geri alinan stok girislerini haric tut */
...
firebase.messaging();
const VERSION="fatih-cay-evi-r378-rapor-stok-geri-alma",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
