...
firebase.messaging();
const VERSION="fatih-cay-evi-r251-logo-fit",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
const CORE=[
  ...
  "./adisyon/index.html","./adisyon/style.css","./adisyon/script.js","./adisyon/enhancements.css","./adisyon/enhancements.js","./adisyon/internal-consumption.js","./adisyon/polish.css","./adisyon/quick-cash.css","./adisyon/quick-cash.js","./adisyon/history-modal.css","./adisyon/history-modal.js","./adisyon-gecmisi/","./adisyon-gecmisi/index.html","./adisyon-gecmisi/style.css","./adisyon-gecmisi/script.js",
