/* R360 - Personel cikis sistem onay penceresi */
...
firebase.messaging();
const VERSION="fatih-cay-evi-r360-personel-cikis-onayi",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
const CORE=[
