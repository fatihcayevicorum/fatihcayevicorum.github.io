/* R357 - Aktarim modal olcusu gelir ekraniyla ayni */
...
firebase.messaging();
const VERSION="fatih-cay-evi-r357-aktarim-modal-olcusu",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
const CORE=[
