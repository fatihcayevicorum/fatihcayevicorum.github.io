/* R359 - Aktarim gider liste alanini birebir kullaniyor */
...
firebase.messaging();
const VERSION="fatih-cay-evi-r359-aktarim-gider-liste",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
const CORE=[
