/* R380 - Adisyon son 30 gun sik kullanilan urun siralamasi */
...
firebase.messaging();
const VERSION="fatih-cay-evi-r380-adisyon-30-gun-urun-siralamasi",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
