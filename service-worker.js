/* R385 - Organizasyon masa rengi ve sabit hesap tablosu */
...
firebase.messaging();
const VERSION="fatih-cay-evi-r385-organizasyon-hesap-tablosu",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
