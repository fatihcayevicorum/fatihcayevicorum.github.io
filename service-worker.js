/* R354 - Aktarim kart yuksekligi gider duzeni */
...
firebase.messaging();
const VERSION="fatih-cay-evi-r354-aktarim-kategorileri-kart",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
const CORE=[
