/* R347 - Kasa aylik raporunda gercek cari alacak bakiyesi */
...
firebase.messaging();
const VERSION="fatih-cay-evi-r347-kasa-cari-alacak-bakiyesi",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
const CORE=[
