/* R355 - Aktarim sayfasi gelir gider olculeri */
...
firebase.messaging();
const VERSION="fatih-cay-evi-r355-aktarim-kategorileri-olcu",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
const CORE=[
