/* R351 - Hesap aktarim kategorileri yonetimi */
...
firebase.messaging();
const VERSION="fatih-cay-evi-r351-aktarim-kategorileri",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
const CORE=[
