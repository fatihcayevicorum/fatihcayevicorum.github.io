...
firebase.messaging();
const VERSION="fatih-cay-evi-r356-aktarim-kategorileri-responsive",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
const CORE=[
