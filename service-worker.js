/* R353 - Aktarim kategorileri iki sutun duzeni */
...
firebase.messaging();
const VERSION="fatih-cay-evi-r353-aktarim-kategorileri-duzen",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
const CORE=[
