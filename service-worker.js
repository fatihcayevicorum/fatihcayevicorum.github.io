/* R358 - Aktarim sayfasi gider kategorileriyle ayni */
...
firebase.messaging();
const VERSION="fatih-cay-evi-r358-aktarim-gider-sayfasi",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
const CORE=[
