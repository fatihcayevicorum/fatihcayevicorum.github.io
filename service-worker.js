/* R373 - Asistan stok baglantisini esas alir */
...
firebase.messaging();
const VERSION="fatih-cay-evi-r373-asistan-stok-maliyeti",STATIC_CACHE=`${VERSION}-static`,RUNTIME_CACHE=`${VERSION}-runtime`;
