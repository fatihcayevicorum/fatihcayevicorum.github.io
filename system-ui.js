...
const panelMenu=document.querySelector(".panel-menu-list"),isHomeManagement=location.pathname.includes("/ana-sayfa-yonetimi/"),isDataManagement=location.pathname.includes("/veri-yonetimi/"),isNotificationManagement=location.pathname.includes("/bildirim-yonetimi/"),hasHomeManagement=panelMenu?.querySelector('[href*="ana-sayfa-yonetimi"]')||(isHomeManagement&&panelMenu?.querySelector('a[href="./"]')),hasDataManagement=panelMenu?.querySelector('[href*="veri-yonetimi"]')||(isDataManagement&&panelMenu?.querySelector('a[href="./"]')),hasNotificationManagement=panelMenu?.querySelector('[href*="bildirim-yonetimi"]')||(isNotificationManagement&&panelMenu?.querySelector('a[href="./"]'));if(panelMenu&&!hasDataManagement)panelMenu.insertAdjacentHTML("beforeend",'<a href="../veri-yonetimi/"><i class="fa-solid fa-database"></i>Veri ve Yedekleme</a>');if(panelMenu&&!hasHomeManagement)panelMenu.insertAdjacentHTML("beforeend",'<a href="../ana-sayfa-yonetimi/"><i class="fa-solid fa-house"></i>Ana Sayfa Yönetimi</a>');if(panelMenu&&!hasNotificationManagement)panelMenu.insertAdjacentHTML("beforeend",'<a href="../bildirim-yonetimi/"><i class="fa-solid fa-bell"></i>Bildirim Yönetimi</a>');
