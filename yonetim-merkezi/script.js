...
const management=[
  ...
  {permission:"credit",name:"Açık Hesap Müşterileri",description:"Müşteri hesaplarını ve ödemeleri yönet",path:"acik-hesap/",icon:"fa-address-book"},
  ...
  {permission:"notifications",name:"Bildirim Yönetimi",description:"Müşteri, yönetici ve esnafa bildirim gönder",path:"bildirim-yonetimi/",icon:"fa-bell"},
