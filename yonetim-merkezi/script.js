...
const management=[
  ...
  {permission:"reports",name:"İşletme Asistanı",description:"Satış, maliyet, stok ve çay verilerini karşılaştırmalı analiz et",path:"isletme-asistani/?v=307",icon:"fa-wand-magic-sparkles"},
